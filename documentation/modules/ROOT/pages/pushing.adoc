...
IMPORTANT: Before continuing you will need to have/create a container registry account. You can sign up for a free one at https://quay.io[Quay.io] or the https://hub.podman.com/[Docker Hub]. 
...
----
podman tag my-image podman.io/myrepository/my-image
----
...
Now if you go to your https://quay.io[Quay.io] or https://hub.podman.com[Docker Hub] account you'll see your image right there.
