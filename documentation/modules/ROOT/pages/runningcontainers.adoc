...
If you removed the image on the previous step, you'll need to build it again:
...
So let's create a dettached container. First we remove this one:
...
And now we create it dettached:
